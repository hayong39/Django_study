...
#     user_name = forms.CharField(label='Your name', max_length=100, widget=forms.TextInput(attrs={'class':'form-control'}))
#     user_age = forms.IntegerField(label='Your age', widget=forms.NumberInput(attrs={'class':'form-contorl'}))
